...
function initializeScript() {
    ...
    Print("------------------------------------------------------------------\n");
    Print("[*]\tWindbg2IDA Version : "+ScriptVersion+" \n");
    Print("[*] Written by Sina Karvandi (@Intel80x86)\n\n");
    Print("\trun\t!windbg2ida\tto see the help !\n\n");
    Print("[*] !!! Important Note : If you want to compare two or more code coverages, then you have to use !windbg2ida_set_color\n");
    Print("[*] to change the color of second or nth sample, otherwise YOU CANNOT SEE THE DIFFERENCE with one color !!! \n");
...
{          
    ...
    Print("\t\t\t Turns coverage color to red.\n");
    Print("\n\t\t e.g : !windbg2ida_set_color 0x36AC29\n");
    Print("\t\t\t Turns coverage color to green.\n");
    Print("\n\t\t e.g : !windbg2ida_set_color 0x1628AC\n");
    Print("\t\t\t Turns coverage color to blue.\n");
    Print("\n\t\t e.g : !windbg2ida_set_color 0xFF0FE0\n");
    Print("\t\t\t Turns coverage color to pink.\n");
    Print("\n");
    Print("\n");
